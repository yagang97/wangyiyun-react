...
class PlaySong extends Component {
    ...
    componentDidMount(){
      this.bScroll = new BScroll("#playSong",{
        probeType: 2,
        click:true,
        bounce:true
      })
          ...
          <BackPage></BackPage>
            ...
            <PlayInfo>
              ...
              <div className="timeWrap">
                <div className="timeShow">00:21</div> 
                <div className="progressWrap"></div>
                <div className="timeEnd">04:46</div>
              </div>
              <div className="playOperate">
                <i className="btnPrev"></i>
                <i className="btnPause"></i>
                <i className="btnNext"></i>
              </div>
              <div className="giude" onClick={this.clickHandler.bind(this)}><i></i>相关资讯</div>
            </PlayInfo>
            <SongMenu></SongMenu>
            <Comment></Comment>
            </div>
